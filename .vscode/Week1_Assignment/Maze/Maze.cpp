...
Maze::Maze(std::ifstream &inputFile)
{
    ...
    cout << "badbit: " << inputFile.bad() << endl
         << endl;
    ...
    {
        cout << "File Accepted. Initializing maze constants: " << endl
             << endl;
    ...
    cout << "Maze construction should be complete." << endl
         << endl;
